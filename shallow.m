...
lgraph_shallow = layerGraph(layers);
...
trainedNet_shallow = trainNetwork(augimdsTrain, lgraph_shallow, options);

%% evaluation
[YValPred,probs] = classify(trainedNet_shallow,XValidation);
validationError = mean(YValPred ~= YValidation);
YTrainPred = classify(trainedNet_shallow,XTrain);
