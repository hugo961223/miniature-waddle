...
trainedNet_resid = trainNetwork(augimdsTrain, lgraph, options);

%% evaluation
[YValPred,probs] = classify(trainedNet_resid,XValidation);
validationError = mean(YValPred ~= YValidation);
YTrainPred = classify(trainedNet_resid,XTrain);
